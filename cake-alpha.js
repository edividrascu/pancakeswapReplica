...
let numbersHeigth = document.getElementById('cake-animation')
let maxScroll = numbersHeigth.offsetTop+48;
...
window.addEventListener ("scroll",() => {
  if(window.scrollY>=maxScroll){
    ...
    // console.log(numbersHeigth.offsetTop)
    maxScroll = document.querySelector('body').scrollHeight;
